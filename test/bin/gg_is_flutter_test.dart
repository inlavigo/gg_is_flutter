...
import '../../bin/gg_is_flutter.dart';

void main() {
  group('bin/gg_is_flutter.dart', () {
    // #########################################################################

    test('should be executable', () async {
      // Execute bin/gg_is_flutter.dart and check if it prints help
      final result = await Process.run(
        './bin/gg_is_flutter.dart',
        ['my-command'],
        stdoutEncoding: utf8,
        stderrEncoding: utf8,
      );
  ...
  group('run(args, log)', () {
    group('with args=[--param, value]', () {
      test('should print "value"', () async {
        // Execute bin/gg_is_flutter.dart and check if it prints "value"
